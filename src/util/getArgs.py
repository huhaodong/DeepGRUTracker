...
def getCmdArgs():
    ...
    parser.add_argument("--gru_hide_size",help="set the gru net hide size",default=1024)
    parser.add_argument("--product_dim",help="set the output dim",default=4)
    parser.add_argument("--sequence_size",help="set the sequence size",default=10)
    ...
    parser.add_argument("--img_resize_w",help="set the input picture resize weight",default=512)
    parser.add_argument("--img_resize_h",help="set the input picture resize height",default=512)
    parser.add_argument("--pic_feature_dim",help="set the picture feature map dim",default=1024)
    parser.add_argument("--det_feature_dim",help="set the det feature map dim",default=1024)
    parser.add_argument("--all_feature_dim",help="set the all feature map dim",default=1024)
    parser.add_argument("--load_epoch",help="set the start epoch",default=960,type=int)
    ...
    parser.add_argument("--fc_sec_hidden_size",help="set the full connect layer hidden size",default=16)
    parser.add_argument("--batch_size",help="set the batch size",default=2,type=int)
    ...
    # parser.add_argument("--is_train",help="set train or test",default=False)
    parser.add_argument("--train",help="set train or test",action='store_true',dest='is_train',default=True)
    parser.add_argument("--test",help="set train or test",action='store_false',dest='is_train',default=True)
    ...
    parser.add_argument("--sequence_info_file_name",help="set sequence info file name",default='seqinfo.ini')
    parser.add_argument("--test_folder_name",help="set test folder name",default='test_tmp')
    ...
    parser.add_argument("--test_loop_size",help="set test loop size",default=1)
    ...
    parser.add_argument("--img_cache_size",help="set img cache size",default=100)
    parser.add_argument("--img_file_type",help="set img file tpye",default='.jpg')
    parser.add_argument("--det_threshold",help="set det keep threshold",default=0.01)
    parser.add_argument("--gru_keep_prob",help="set gru keep prob",default=0.8,type=float)
    parser.add_argument("--nn_keep_prob",help="set fc keep prob",default=0.8,type=float)
    ...
    parser.add_argument("--tracker_result_path",help="set the path of tracker result",default='F:\\work\\workspace\\DeepGRUTracker\\result')
