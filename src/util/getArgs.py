...
def getCmdArgs():
    ...
    parser.add_argument("--gru_hide_size",help="set the gru net hide size",default=4096)
    ...
    parser.add_argument("--pic_feature_dim",help="set the picture feature map dim",default=4096)
    parser.add_argument("--det_feature_dim",help="set the det feature map dim",default=1024)
    parser.add_argument("--all_feature_dim",help="set the all feature map dim",default=4096)
